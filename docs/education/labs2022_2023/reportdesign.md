...
Также вам необходимо создать папку `Labs` с  вложенными папками `lab1`, `lab2` и т.д по количеству лабораторных работ. В каждой папке вы создаете файл lab1_report.md, lab2_report.md и т.д в соответствующих папках.
